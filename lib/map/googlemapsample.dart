...
List<Place> places = [
  Place(
      name: '칸다소바',
      address: '인천 부평구 부평대로36번길 5',
      location: LatLng(37.4910133, 126.7206483)),
  Place(
      name: '인브스키친',
      address: '인천 부평구 부평대로 39-6',
      location: LatLng(37.490815, 126.720895)),
  Place(
      name: '에픽',
      address: '인천 부평구 경원대로1363번길 8',
      location: LatLng(37.490539, 126.718667)),
];
